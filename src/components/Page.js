	...
	return (
		...
		<div className="navbar p-5">
			<select
				...
				className="rounded border appearance-none border-gray-400 py-2 focus:outline-none focus:border-blue-500 text-base pl-3 pr-10 bg-white-300 hover:bg-gray-400"
			>
				...
				{categories.map((category) => (
					<div key={category} className="m-5">
						{currentCategory === "userId" ? (
							...
							alt="user"
							/>
							<h1 className="font-bold text-base text-opacity-5 pl-6 pb-2">{mapping[category]}</h1>
							</div>
